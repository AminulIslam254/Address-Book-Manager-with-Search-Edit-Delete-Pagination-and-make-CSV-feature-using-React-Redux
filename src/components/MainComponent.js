//Main component that has List, Pagination, Add user, Edit user, Delete User and Download as CSV feature
...
const MainComponent = () => {
    ...
    //Currect selected Product index
    ...
    //Useeffect to sort data after adding new alement on list
    useEffect(() => {
